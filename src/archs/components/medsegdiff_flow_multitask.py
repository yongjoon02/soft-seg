"""MedSegDiff flow backbone with 2-channel output (multi-task, no gating)."""
import math
...
class MedSegDiffFlowMultiTask(nn.Module):
    """MedSegDiff UNet used as a flow-matching backbone (2-channel multi-task)."""
    ...
    def forward(self, x, time, cond):
        ...
        v_hard = self.hard_head(common_feat)
