...
DATASET_REGISTRY = {
    ...
    'xca': DatasetInfo(
        ...
        num_val=12,
        num_test=24,
        description='XCA vessel segmentation dataset',
        default_crop_size=320,
        default_batch_size=4,
        default_train_dir='data/xca_dataset_split/train',
        default_val_dir='data/xca_dataset_split/val',
        default_test_dir='data/xca_dataset_split/test',
    ),
}
